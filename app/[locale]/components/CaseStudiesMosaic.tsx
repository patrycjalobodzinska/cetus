            ...
            {c.image && (
              <>
                ...
                <img
                  ...
                  alt=""
                  aria-hidden="true"
                  className="rounded-tl-2xl border-l-6 border-t-6 border-gray-800  cs-card-shot shadow-2xl shadow-blue-300  pointer-events-none absolute -bottom-6 -right-7 h-52 w-[22rem] object-[0%_top] object-cover md:-bottom-12 md:-right-0 md:h-64 md:w-96 lg:h-80 lg:w-[30rem]"
                />
