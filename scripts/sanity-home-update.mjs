...
const heroDescriptionPl = 'Tworzymy nowoczesne oprogramowanie, które realnie pomaga firmom się rozwijać. Doradzamy, budujemy i wspieramy aplikacje webowe, mobilne oraz rozwiązania AI — od pomysłu, przez projektowanie UX/UI, po wdrożenie i długofalowy rozwój. Specjalizujemy się w projektach, które porządkują procesy, skracają czas operacji i zapewniają przewagę konkurencyjną na rynku.';

const heroDescriptionEn = 'We create modern software that helps companies grow. We advise, build and support web applications, mobile apps and AI solutions — from the initial idea through UX/UI design to implementation and long-term development. We specialize in projects that organize processes, shorten operations and provide measurable competitive advantage.';

const offerDescriptionPl = 'Kompleksowe rozwiązania IT dostosowane do potrzeb Twojego biznesu. Tworzymy nowoczesne aplikacje webowe i mobilne, projektujemy interfejsy UX/UI, wdrażamy rozwiązania AI, cybersecurity oraz transformację technologiczną. Każdy projekt prowadzimy od analizy i strategii, przez development i wdrożenie, po wsparcie techniczne — tak, aby oprogramowanie realnie pomagało firmom się rozwijać i osiągać cele biznesowe.';

const offerDescriptionEn = 'Comprehensive IT solutions tailored to your business needs. We create modern web and mobile applications, design UX/UI interfaces, implement AI, cybersecurity and technological transformation. We lead each project from analysis and strategy, through development and implementation, to technical support — so that software truly helps companies grow and achieve their business goals.';

const processDescriptionPl = 'Tworzymy nowoczesne oprogramowanie w ustrukturyzowanym, przewidywalnym procesie. Od audytu, przez projektowanie i development, po wdrożenie i wsparcie — każdy etap porządkuje działania i dowozi mierzalne efekty, które realnie pomagają firmom się rozwijać.';

const processDescriptionEn = 'We create modern software in a structured, predictable process. From audit, through design and development, to implementation and support — each stage organizes activities and delivers measurable results that truly help companies grow.';
...
console.log('OK:', result.results.map((r) => `${r.id}: ${r.operation}`).join(', '));
