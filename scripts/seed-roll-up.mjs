...
const doc = {
  ...
  stats: [
    ...
    { _key: _key(), value: '6', label: ls('lat doświadczenia', 'years of experience') },
  ...
  businessServices: [
    {
      ...
      description: ls('Nowoczesne systemy webowe szyte na miarę.', 'Tailored modern web systems.'),
      icon: 'code',
  ...
  careerBullets: [
    ...
    ls('Mentoring oraz realne projekty komercyjne', 'Mentoring and real commercial projects'),
    ls(
...
async function main() {
  console.log(`Seeding rollUpPage to dataset "${env.NEXT_PUBLIC_SANITY_DATASET}"...`);
