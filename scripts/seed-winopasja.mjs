  ...
  sections: [
    ...
    // 4. Scope Section
    {
      ...
      items: [
        {
          _key: 'scope-item1',
          text: { _type: 'localeString', pl: 'Marketplace sprzedaży produktów', en: 'Product sales marketplace' },
        },
        {
          _key: 'scope-item2',
          text: { _type: 'localeString', pl: 'Panel klienta końcowego', en: 'End customer panel' },
        },
        {
          _key: 'scope-item3',
          text: { _type: 'localeString', pl: 'Panel producenta (winiarni)', en: 'Producer (winery) panel' },
        },
        {
          _key: 'scope-item4',
          text: { _type: 'localeString', pl: 'Panel administracyjny', en: 'Admin panel' },
        },
        {
          _key: 'scope-item5',
          text: { _type: 'localeString', pl: 'Moduły marketingowe i enoturystyczne', en: 'Marketing and enotourism modules' },
        },
        {
          _key: 'scope-item6',
          text: { _type: 'localeString', pl: 'Integracje płatności, kurierów i fakturowania', en: 'Payment, courier and invoicing integrations' },
        },
        {
          _key: 'scope-item7',
          text: { _type: 'localeString', pl: 'Infrastruktura cloud', en: 'Cloud infrastructure' },
        },
        {
          _key: 'scope-item8',
          text: { _type: 'localeString', pl: 'Proof of Concept systemu VMS', en: 'VMS system Proof of Concept' },
        },
      ],
      note: {
        _type: 'localeText',
...
async function seed() {
  ...
  try {
    ...
    if (error.statusCode === 403) {
      console.error('   Token lacks write permissions. Generate an Editor token at sanity.io/manage.');
    }
  }
}
