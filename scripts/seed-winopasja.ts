...
const winopasjaDoc = {
  ...
  sections: [
    ...
    // 5. Modules
    {
      ...
      items: [
        ...
        },
        {
          _key: key(),
          title: {
            pl: "Vouchery i karty podarunkowe",
            en: "Vouchers & Gift Cards",
          },
          description: {
            pl: [
    ...
    // 7. Technologies
    {
      ...
      items: [
        { _key: key(), name: "Next.js" },
        { _key: key(), name: "NestJS" },
        { _key: key(), name: "React Native" },
        { _key: key(), name: "PostgreSQL" },
        { _key: key(), name: "Redis" },
        { _key: key(), name: "Przelewy24" },
        { _key: key(), name: "AWS" },
        { _key: key(), name: "Docker" },
      ],
    },
...
async function main() {
  if (!process.env.SANITY_API_TOKEN) {
    console.error(
      "❌  SANITY_API_TOKEN is not set. Add it to .env.local and re-run.",
    );
    process.exit(1);
  }
