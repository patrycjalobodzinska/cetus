...
export const csHeroSection = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "url",
      description:
        "Link do strony projektu - wyświetlany jako interaktywny podgląd po prawej stronie.",
    }),
  ],
  preview: {
  ...
  fields: [
    defineField({
      ...
      options: {
        list: [
          {
            title: "Narrative - opis + lista bulletów full-width",
            value: "narrative",
          },
          {
            title: "Two-column - problem i konsekwencja obok siebie",
            value: "two-column",
          },
        ],
        layout: "radio",
  ...
  fields: [
    defineField({
      ...
      options: {
        list: [
          {
            title: "Alternating - naprzemienne układy L/P",
            value: "alternating",
          },
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          {
            title: "Stacked - efekt stackowania (jak usługi)",
            value: "stacked",
          },
        ],
        layout: "radio",
    ...
    defineField({
      ...
      of: [
        defineArrayMember({
          ...
          preview: {
            select: { title: "title.pl", subtitle: "description.pl" },
          },
        }),
      ],
    }),
  ...
  fields: [
    defineField({
      ...
      options: {
        list: [
          {
            title: "Circuit - poligon z SVG liniami (kilka technologii)",
            value: "circuit",
          },
          {
            title: "Badges - tagi/pillsy (kilka technologii)",
            value: "badges",
          },
          {
            title: "Karuzela - przewijana w pętli (wiele technologii)",
            value: "carousel",
          },
        ],
        layout: "radio",
  ...
  fields: [
    defineField({
      ...
      options: {
        list: [
          {
            title: "Centered - cytat na środku, duża czcionka",
            value: "centered",
          },
          {
            title: "Blockquote - wyrównany do lewej z autorem",
            value: "blockquote",
          },
        ],
        layout: "radio",
...
export const csCtaSection = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "buttonLabel",
      title: "Etykieta przycisku (opcjonalne)",
      type: "localeString",
    }),
    defineField({
      name: "buttonHref",
